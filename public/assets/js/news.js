export const news = {
  ...
  getDigitalForensicsNews() {
    const news = [
      {
        title: 'Title',
        image: '../../../uploads/Features-card-images/digital-forensics-background.webp',
        article: 'article'
      },
  ...
  getPenetrationTestingNews() {
    const news = [
      {
        title: 'Title',
        image: '../../../uploads/Features-card-images/penetration-testing-background.webp',
        article: 'article'
      },
  ...
  getReverseEngineeringNews() {
    const news = [
      {
        title: 'Title',
        image: '../../../uploads/Features-card-images/reverse-engineering-background.webp',
        article: 'article'
      },
  ...
  getRedTeamNews() {
    const news = [
      {
        title: 'Title',
        image: '../../../uploads/Features-card-images/rb-team-background.webp', 
        article: 'article'
      },
  ...
  getThreatIntelligenceNews() {
    const news = [
      {
        title: 'Title',
        image: '../../../uploads/Features-card-images/threat-intelligence-background.webp',
        article: 'article'
      },
  ...
  getIdentityAccessManagementNews() {
    const news = [
      {
        title: 'Title',
        image: '../../../uploads/Features-card-images/identity-access-management-background.webp',   
        article: 'article'
      },
  ...
  getMalwareAnalysisNews() {
    const news = [
      {
        title: 'Title',
        image: '../../../uploads/Features-card-images/malware-analysis-background.webp',
        article: 'article'
      },
  ...
  getIotNews() {
    const news = [
      {
        title: 'Title',
        image: '../../../uploads/Features-card-images/iot-security-background.webp',
        article: 'article'
      },
